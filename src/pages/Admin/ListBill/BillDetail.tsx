...
import { apiChangeStatusOrder } from '@/services/bill'
const BillDetail = () => {
    const handlePrint = () => {
                        ...
                        <div className='flex flex-col gap-3 pl-2'>
                            ...
                            <Dialog open={open} onOpenChange={setOpen}>
                                ...
                                <DialogContent className='sm:max-w-[425px]'>
                                    <DialogHeader>
                                        <DialogTitle>Thay đổi trạng thái giáo hàng</DialogTitle>
                                        <DialogDescription>
                                            Cập nhật trạng thái giao hàng do nhận viên hoặc shiper thông báo
                                        </DialogDescription>
                                    </DialogHeader>
                                    <Form {...form}>
                                        <form
