                    ...
                    <div className='row align-items-center mb-5'>
                        ...
                        <div className='col-lg-4'>
                            <p className='mb-0'>
                                ...
                                mình! Chúng tôi cung cấp một môi trường rất ấm áp và thân thiện cho vật nuôi của bạn.
                                Đội ngũ chuyên nghiệp của chúng tôi đảm bảo chất lượng về thức ăn và phụ kiện cho mèo
                                của bạn ở mức cao nhất vì chúng tôi đối xử với tất cả thú cưng như thể chúng là của
                                mình!!
                            </p>
                        </div>
                        ...
                        <div className='col-lg-4 col-md-6'>
                            <div className='sigma_info style-25 d-block d-xl-flex'>
                                ...
                                <div className='sigma_info-description mt-4 mt-xl-0'>
                                    ...
                                    <p>Đội ngũ chuyên nghiệp của chúng tôi cung cấp thức ăn và phụ kiện đặc biệt.</p>
